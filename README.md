...
The tunnel length cannot be lowered more than the minimum mentioned above and not more than the section the player is in plus two. The tunnel length cannot grow further than the maximum mentioned above.
